    ...
    static class Validacion
    {
      ...
      //Valida que un numero sea de solo 4 cifras 
        ...
        public static Boolean fechaAnteriorALaDeHoy(DateTimePicker dateTimePicker1)
        {
            if (dateTimePicker1.Value.Date > DateTime.Now.Date)
            {
                MessageBox.Show("La fecha ingresada debe ser anterior a la fecha de hoy" + dateTimePicker1.Value + DateTime.Now.Date, "Error en los datos de entrada", MessageBoxButtons.OK);
